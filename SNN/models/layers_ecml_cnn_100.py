        ...
        if self.with_group :
            ...
            if self.index <= 3:       
                ...
                if indicator%2==0: 
                    ...
                    g2,self.c1_mem,self.c2_mem = self.snn_g1(patch_group_2,self.c1_mem,(self.c1_mem+self.c2_mem)/2)
                    #print(self.c1_mem,"self.c1_mem2")
                    g3,self.c1_mem,self.c2_mem = self.snn_g1(patch_group_3,self.c1_mem,(self.c1_mem+self.c2_mem)/2)
                    #print(self.c1_mem,"self.c1_mem3")
                    g4,self.c1_mem,self.c2_mem = self.snn_g1(patch_group_4,self.c1_mem,(self.c1_mem+self.c2_mem)/2)
                    ...
                    if self.index == 3:   
                        ...
                        if self.union == "cat":
                            ...
                            x = torch.where(x > 0.2, one, x).cuda()
                        if self.with_fc:      
